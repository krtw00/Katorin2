  ...
  public: {
    Tables: {
      ...
      league_points: {
        ...
        Relationships: [
          {
            foreignKeyName: "league_points_leagues_id_fkey"
            columns: ["league_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "league_points_round_id_fkey"
            columns: ["round_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "league_points_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
        ...
        Relationships: [
          {
            ...
            columns: ["block_id"]
            isOneToOne: false
            referencedRelation: "round_blocks"
            referencedColumns: ["id"]
          },
          {
      ...
      participants: {
        ...
        Relationships: [
          {
            foreignKeyName: "participants_round_id_fkey"
            columns: ["round_id"]
            isOneToOne: false
            referencedRelation: "rounds"
            referencedColumns: ["id"]
      ...
      round_blocks: {
        ...
        Relationships: [
          {
            foreignKeyName: "round_blocks_leagues_id_fkey"
            columns: ["league_id"]
            isOneToOne: false
            referencedRelation: "leagues"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "round_blocks_round_id_fkey"
            columns: ["round_id"]
            isOneToOne: false
            referencedRelation: "rounds"
            referencedColumns: ["id"]
      ...
      rounds: {
        ...
        Relationships: [
          {
            foreignKeyName: "rounds_leagues_id_fkey"
            columns: ["league_id"]
            isOneToOne: false
            referencedRelation: "leagues"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "rounds_source_round_id_fkey"
      ...
      swiss_standings: {
        ...
        Relationships: [
          {
            foreignKeyName: "swiss_standings_round_id_fkey"
            columns: ["round_id"]
            isOneToOne: false
            referencedRelation: "rounds"
            referencedColumns: ["id"]
      ...
      team_applications: {
        ...
        Relationships: [
          {
            foreignKeyName: "team_applications_leagues_id_fkey"
            columns: ["league_id"]
            isOneToOne: false
            referencedRelation: "leagues"
            referencedColumns: ["id"]
      ...
      team_entries: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "team_entries_round_id_fkey"
            columns: ["round_id"]
            isOneToOne: false
            referencedRelation: "rounds"
            referencedColumns: ["id"]
      ...
      teams: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "teams_leagues_id_fkey"
            columns: ["league_id"]
            isOneToOne: false
            referencedRelation: "leagues"
            referencedColumns: ["id"]
      ...
      tournament_invites: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "tournament_invites_round_id_fkey"
            columns: ["round_id"]
            isOneToOne: false
            referencedRelation: "rounds"
            referencedColumns: ["id"]
